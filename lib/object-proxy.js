...
Object.defineProperty(ObjectProxy.prototype, 'init', {
  writable: true,
...
function _defineProperties (constr, definition) {
...
ObjectProxy.create = function (definition, constr) {
  constr = constr || function (obj) {
    ObjectProxy.call(this, obj);
  }
  util.inherits(constr, ObjectProxy);
  constr = _defineProperties(constr, definition);
  constr.name = constr.__name = definition.name;
  constr.prototype.__definition = definition;
  return constr;
};

ObjectProxy.extend = function (proxy, definition) {
  var superDef = proxy.prototype.__definition;
  _.defaults(definition.properties, superDef.properties);
  proxy = _defineProperties(proxy, definition);
  proxy.name = proxy.__name = definition.name;
  proxy.prototype.__definition = definition;
  return proxy;
};
