...
function buildPropertySchema (name, propertyDef) {
  ...
  switch (propertyDef.type.trim().toLowerCase()) {
    case 'array':
      ...
      if ('undefined' !== typeof propertyDef.items) {
        schema = schema.includes(buildPropertySchema(name + '.items', propertyDef.items));
      }
      if ('undefined' !== typeof propertyDef.sparse) { schema = schema.sparse(propertyDef.sparse); }
      if ('undefined' !== typeof propertyDef.unique) { schema = schema.unique(); }
      break;
    case 'binary':
      schema = joi.binary();
    ...
    case 'date':
      schema = joi.date();
      if ('undefined' !== typeof propertyDef.iso) { schema = schema.iso(); }
    ...
    case 'number':
      ...
      if ('undefined' !== typeof propertyDef.negative) { schema = schema.negative(); }
      if ('undefined' !== typeof propertyDef.positive) { schema = schema.positive(); }
      break;
    case 'object':
      schema = joi.object();
    ...
    case 'string':
      schema = joi.string();
      if ('undefined' !== typeof propertyDef.insensitive) { schema = schema.insensitive(); }
      if ('undefined' !== typeof propertyDef.creditCard) { schema = schema.creditCard(); }
      if ('undefined' !== typeof propertyDef.regex) { schema = schema.regex(propertyDef.regex); }
      if ('undefined' !== typeof propertyDef.alphanum) { schema = schema.alphanum(); }
      if ('undefined' !== typeof propertyDef.token) { schema = schema.token(); }
      if ('undefined' !== typeof propertyDef.email) { schema = schema.email(); }
      if ('undefined' !== typeof propertyDef.guid) { schema = schema.guid(); }
      if ('undefined' !== typeof propertyDef.hostname) { schema = schema.hostname(); }
      if ('undefined' !== typeof propertyDef.lowercase) { schema = schema.lowercase(); }
      if ('undefined' !== typeof propertyDef.uppercase) { schema = schema.uppercase(); }
      if ('undefined' !== typeof propertyDef.trim) { schema = schema.trim(); }
      break;
    case 'objectid':
  ...
  if ('undefined' !== typeof propertyDef.forbidden) { schema = schema.forbidden(); }
  if ('undefined' !== typeof propertyDef.strip) { schema = schema.strip(); }
  if ('undefined' !== typeof propertyDef.required) { schema = schema.required(); }
  ...
  if ('undefined' !== typeof propertyDef.raw) { schema = schema.raw(); }
