...
function buildPropertySchema (name, propertyDef) {
  ...
  switch (propertyDef.type.trim().toLowerCase()) {
    case 'array':
      ...
      if (typeof propertyDef.unique) { schema = schema.unique(); }
      break;
    case 'binary':
      schema = joi.binary();
    ...
    case 'date':
      schema = joi.date();
      if (typeof propertyDef.iso) { schema = schema.iso(); }
    ...
    case 'number':
      ...
      if (typeof propertyDef.negative) { schema = schema.negative(); }
      if (typeof propertyDef.positive) { schema = schema.positive(); }
      break;
    case 'object':
      schema = joi.object();
    ...
    case 'string':
      schema = joi.string();
      if (typeof propertyDef.insensitive) { schema = schema.insensitive(); }
      if (typeof propertyDef.creditCard) { schema = schema.creditCard(); }
      if ('undefined' !== typeof propertyDef.regex) { schema = schema.regex(propertyDef.regex); }
      if (typeof propertyDef.alphanum) { schema = schema.alphanum(); }
      if (typeof propertyDef.token) { schema = schema.token(); }
      if (typeof propertyDef.email) { schema = schema.email(); }
      if (typeof propertyDef.guid) { schema = schema.guid(); }
      if (typeof propertyDef.hostname) { schema = schema.hostname(); }
      if (typeof propertyDef.lowercase) { schema = schema.lowercase(); }
      if (typeof propertyDef.uppercase) { schema = schema.uppercase(); }
      if (typeof propertyDef.trim) { schema = schema.trim(); }
      break;
    case 'objectid':
  ...
  if (typeof propertyDef.forbidden) { schema = schema.forbidden(); }
  if (typeof propertyDef.strip) { schema = schema.strip(); }
  if (typeof propertyDef.required) { schema = schema.required(); }
  ...
  if (typeof propertyDef.raw) { schema = schema.raw(); }
