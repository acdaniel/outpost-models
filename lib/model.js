...
Model.extend = function (definition) {
  ...
  var constr = function (db, data) {
    ...
    for (var p in definition.properties) {
      var propertyDef = definition.properties[p];
      if (typeof propertyDef.default === 'undefined') {
        continue;
      }
      var val = (typeof propertyDef.default === 'function') ?
        propertyDef.default() : propertyDef.default;
      var currentVal = this.get(p);
      if (typeof currentVal === 'undefined') {
        debug('defaulting ' + p + ' to ' + val);
        this.set(p, val, { silent: true });
      }
    }
  ...
  constr.prototype.validate = function (options) {
    ...
    joi.validate(this.toJSON(), schema, options, function (err, value) {
          ...
          if (!this.isModified()) {
            ...
            if (this._id) {
              ...
              for (var p in this.__modified) {
                $set[p] = this.__modified[p].newValue;
              }
              $set = { $set: $set };
